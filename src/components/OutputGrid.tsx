...
const STAGE_REPORT_BEAUTIFY_OUTPUT_SHEETS = [
  ...
  ["Sheet 2", "阶段性报告申诉情况", "保留阶段性报告申诉原始信息，不覆盖任何业务结论。"],
  ["Sheet 3", "教研组维度", "按项目、教研组分层汇总阶段性报告，不展示负责人。"],
  ["Sheet 4", "助理主管维度", "按项目、教研组、助理主管分层汇总阶段性报告，保留各级小计和总计。"],
  ["Sheet 5", "师训组长维度", "按师训组长整理阶段性报告发送率，附发送率数据条。"],
  ["Sheet 6", "教师维度", "保留阶段性报告口径，以及原始完成和通知字段。"],
] as const;
